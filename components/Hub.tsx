    ...
    <div className="fixed inset-0 w-full h-full bg-slate-900 overflow-hidden font-sans select-none flex items-center justify-center">
      ...
      <div className="absolute top-4 right-4 z-50">
        <button 
          ...
          className="bg-white text-slate-700 px-5 py-2.5 rounded-full shadow-lg font-black text-xs sm:text-sm hover:scale-105 active:scale-95 transition-all flex items-center gap-2 border border-slate-200"
        >
          <span>🏠</span>
